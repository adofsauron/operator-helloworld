...
//+kubebuilder:rbac:groups=webapp.com.bolingcavalry,resources=guestbooks/finalizers,verbs=update
...
func (r *GuestbookReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	{
		logger.Info(fmt.Sprintf("GuestbookReconciler::Reconcile guestbook: %v", req))
	}
